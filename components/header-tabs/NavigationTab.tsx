...
export default function NavigationTab({ title }: { title: string }) {
  return (
    <div className="flex gap-x-5 items-center w-fit px-3 py-2 rounded-tl-lg rounded-br-lg cursor-pointer bg-card border border-border hover:bg-border transition-colors duration-200">
